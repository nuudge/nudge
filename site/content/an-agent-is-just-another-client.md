...
My first instinct was the obvious one: add a message bus between agents. A `MessagePeer` tool, a little inbox, some routing. I started — and then stopped, because I'd seen this movie before.
...
## The moment it clicked (for real)
